...
class PowerControllerModel(BaseModel):
    ...
    def initialize_table(self):
        super(PowerControllerModel, self).initialize_table()
    ...
    def tableData(self, requestInfo):
        ...
        for x in result:
            ...
            actions = "<button onclick=\"location.href='%spowercontroller/populate/%d';\" type='button' class='btn btn-block btn-primary'> Populate </button>" % ( request.url_root, temp['id'] )
